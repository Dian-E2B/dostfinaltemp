                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div style="margin-bottom: 10px; margin-top: -35px;">Congratulations for qualifying for the <?php echo date('Y'); ?> DOST-SEI S&T Undergraduate Scholarships under <strong style="color: red">[PROGRAM]</strong>.</div>
