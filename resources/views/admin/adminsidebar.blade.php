<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        <a class='sidebar-brand no-right-click'>
            <div class="row">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="{{ request()->is('') ? 'sidebar-item active' : 'sidebar-item' }}">
                ...
                <a class='sidebar-link' href='{{ route('adminapproval') }}'>
                    <i class="align-middle" data-feather="user-check"></i> <span class="align-middle">Approval Request</span>
                </a>
            </li>
